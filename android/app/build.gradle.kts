...
android {
    namespace = "com.example.servicio_sobriedad_plenitud"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.servicio_sobriedad_plenitud"
...
dependencies {
    ...
    // Cuidado de confundir la sintaxis de Kotlin DSL y Groovy DSL
}